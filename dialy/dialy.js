...
var imageArray = [];
var output,html;
console.log('dialyClearner.js invoked...')
function getWords() {
...
function createElements() {
 ...
 output=`<div id='${page_url}' class='lesson-wrapper'> <header><h2>${page_url}</h2></header> <div class='audio-wrapper'> <audio controls preload='auto'> <source src='#' type='audio/mpeg'> Your browser not support audio format. </audio> </div>
  `;
