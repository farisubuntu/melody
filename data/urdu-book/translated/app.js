...
function showContent(n, sender) {
 ...
 switch (n) {
  case 1:
   ch_content_wrapper.innerHTML = ch1_ar;
   break;
  case 2:
   ch_content_wrapper.innerHTML = ch2_ar;
   break;
  case 3:
   ch_content_wrapper.innerHTML = ch3_ar;
   break;
  case 4:
   ch_content_wrapper.innerHTML = ch4_ar;
   break;
  case 5:
   ch_content_wrapper.innerHTML = ch5_ar;
   break;
  case 6:
   ch_content_wrapper.innerHTML = ch6_ar;
   break;
  case 7:
   ch_content_wrapper.innerHTML = ch7_ar;
   break;
  case 8:
   ch_content_wrapper.innerHTML = ch8_ar;
   break;
  default:
